...
export const Modal: React.FC<ModalProps> = ({ open, onClose, title, children }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[min(92vw,640px)] rounded-lg bg-card text-text shadow-xl border border-secondary/40">
